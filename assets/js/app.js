...
const USAGE_TEXT =
`【공통 절차】
1. AI 입력창에서 편집검토 프롬프트를 붙여넣습니다.
2. 「시작」이라고 입력합니다.
3. AI가 요청하면 규정집 PDF와 논문 PDF를 업로드합니다.
4. 논문 전수 검토를 요청하고, 아래 도구별 문구를 입력하여 결과 출력을 요청합니다.

【AI 도구별 출력 요청 문구】
• Claude  : 「논문을 전수 검토하고, 최종 결과를 docx 파일로 만들어줘」
• Gemini  : 「논문을 전수 검토하고, 최종 결과를 Google Docs 문서로 만들어줘」
• ChatGPT : 「논문을 전수 검토하고, 최종 결과를 Excel 파일로 만들어줘」
